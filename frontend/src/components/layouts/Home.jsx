  ...
  return (
    <Fragment>
      <MetaData
        ...
        keywords="electronics, gadgets, smart devices"
      />
        ...
        <div className="row">
          <div className="col-sm-12 col-md-6 col-lg-3 my-3">
            <div className="card p-3 rounded">
              <img className="card-img-top mx-auto" src={productImg} />
          ...
          <div className="col-sm-12 col-md-6 col-lg-3 my-3">
            <div className="card p-3 rounded">
              <img className="card-img-top mx-auto" src={productImg2} />
              <div className="card-body d-flex flex-column">
                <h5 className="card-title">
                  <a href="">
          ...
          <div className="col-sm-12 col-md-6 col-lg-3 my-3">
            <div className="card p-3 rounded">
              <img className="card-img-top mx-auto" src={productImg3} />
              <div className="card-body d-flex flex-column">
                <h5 className="card-title">
                  <a href="">
          ...
          <div className="col-sm-12 col-md-6 col-lg-3 my-3">
            <div className="card p-3 rounded">
              <img className="card-img-top mx-auto" src={productImg4} />
              <div className="card-body d-flex flex-column">
                <h5 className="card-title">
                  <a href="">
          ...
          <div className="col-sm-12 col-md-6 col-lg-3 my-3">
            <div className="card p-3 rounded">
              <img className="card-img-top mx-auto" src={productImg5} />
              <div className="card-body d-flex flex-column">
                <h5 className="card-title">
